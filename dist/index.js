	...
	createClass(SafeImage, [{
		...
		value: function render() {
			return React__default.createElement(
				...
				null,
				this.props.showDimensions && !this.state.errored && React__default.createElement(
					'span',
	...
	createClass(Grid, [{
		...
		value: function render() {
			...
			return React__default.createElement(
				...
				this.props.showDimensions && React__default.createElement(
					"p",
				...
				React__default.createElement(
					...
					!this.state.loading && this.props.images && this.props.images.length ? this.props.images.map(function (image, i) {
						return React__default.createElement(
							...
							_this4.state.imageSelectedIndex == i && React__default.createElement("div", { className: styles.gridOverlay }),
							React__default.createElement(SafeImage, {
								alt: image.url,
		...
		value: function render() {
			return React__default.createElement(
				...
				React__default.createElement(
					...
					this.state.errors && Array.isArray(this.state.errors) && React__default.createElement(
						"div",
